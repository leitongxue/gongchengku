...
var questions = [{
  ...
  hint: 'This will generate test-main_one.js/coffee that configures RequireJS and starts the tests.',
  options: ['no', 'yes'],
  boolean: true,
  ...
  hint: 'This should be a script that bootstraps your test by configuring Require.js and ' +
        'kicking __karma__.start(), probably your test-main_one.js file.\n' +
        'Enter empty string to move to the next question.',
  multiple: true,
  validate: validatePattern,
  condition: function(answers) {
...
exports.init = function(config) {
  ...
  sm.process(questions, function(answers) {
    ...
    var testMainFile = (/\.coffee$/).test(configFile) ? 'test-main.coffee' : 'test-main_one.js';
